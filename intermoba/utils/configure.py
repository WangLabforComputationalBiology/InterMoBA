from intermoba.feats.gnina_types.gnina_featurizer import obabel_mol_parser, PLIPAtomFeaturizer, PLIPEdgeFeaturizer, \
    obabel_ppi_parser
from intermoba.feats.residue.residue_featurizer import ReisdueCAFeaturizer, residue_parser

model_list = ['intermoba', 'PPIScorer']
