...
from intermoba.utils.configure import model_list, get_exp_configure
from intermoba.utils.train_utils import get_model_arg
...
def get_args():
    ...
    parser.add_argument('-model', type=str,
                        choices=model_list,
                        default='intermoba', help='Model to use')
